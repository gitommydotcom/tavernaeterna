...
export default function Layout({ children }) {
  ...
  return (
    <div className="lt-layout" style={{ display: 'flex', height: '100vh', overflow: 'hidden', background: '#0d0f18' }}>
      {/* Desktop sidebar */}
      ...
      {/* Main content */}
      <div className="lt-content" style={{ flex: 1, overflow: 'auto', display: 'flex', flexDirection: 'column' }}>
        {/* Mobile header */}
        {isMobile && (
      ...
      {/* Mobile bottom nav */}
      {isMobile && <div className="lt-bottom-nav"><BottomNav /></div>}
    </div>
  )
}
