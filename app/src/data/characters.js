...
// Preset di mostri "rapidi" usati nella sezione Combattimento.
// Per il catalogo completo (con stat block), usare la sezione DM → Mostri.
export const PRESET_MONSTERS = [
  ...
  { name: 'Guardia', hp_max: 11, ac: 16, initiative_bonus: 1, color: '#3b82f6' },
  { name: 'Lupo', hp_max: 11, ac: 13, initiative_bonus: 2, color: '#78716c' },
  { name: 'Mastino', hp_max: 5, ac: 12, initiative_bonus: 2, color: '#854d0e' },
  { name: 'Scheletro', hp_max: 13, ac: 13, initiative_bonus: 2, color: '#94a3b8' },
  { name: 'Zombie', hp_max: 22, ac: 8, initiative_bonus: -2, color: '#4b5563' },
  { name: 'Cinghiale', hp_max: 11, ac: 11, initiative_bonus: 0, color: '#78716c' },
  // CR 1/2–1
  { name: 'Orco', hp_max: 15, ac: 13, initiative_bonus: 1, color: '#65a30d' },
  { name: 'Hobgoblin', hp_max: 11, ac: 18, initiative_bonus: 1, color: '#7c2d12' },
  { name: 'Gnoll', hp_max: 22, ac: 15, initiative_bonus: 1, color: '#a16207' },
  { name: 'Sahuagin', hp_max: 22, ac: 12, initiative_bonus: 0, color: '#0891b2' },
  { name: 'Berserker', hp_max: 67, ac: 13, initiative_bonus: 1, color: '#7f1d1d' },
  { name: 'Bugbear', hp_max: 27, ac: 16, initiative_bonus: 2, color: '#854d0e' },
  { name: 'Ghoul', hp_max: 22, ac: 12, initiative_bonus: 2, color: '#374151' },
  { name: 'Spettro', hp_max: 22, ac: 12, initiative_bonus: 2, color: '#a78bfa' },
  { name: 'Spia', hp_max: 27, ac: 12, initiative_bonus: 2, color: '#1e293b' },
  { name: 'Tigre', hp_max: 37, ac: 12, initiative_bonus: 2, color: '#ea580c' },
  { name: 'Druido', hp_max: 27, ac: 11, initiative_bonus: 1, color: '#16a34a' },
  // CR 2–4
  { name: 'Cane Demoniaco', hp_max: 45, ac: 15, initiative_bonus: 1, color: '#dc2626' },
  { name: 'Orso Bruno', hp_max: 34, ac: 11, initiative_bonus: 0, color: '#78350f' },
  { name: 'Manticora', hp_max: 68, ac: 14, initiative_bonus: 3, color: '#9a3412' },
  { name: 'Owlbear', hp_max: 59, ac: 13, initiative_bonus: 1, color: '#92400e' },
  { name: 'Grifone', hp_max: 59, ac: 12, initiative_bonus: 2, color: '#a3a3a3' },
  { name: 'Basilisco', hp_max: 52, ac: 15, initiative_bonus: -1, color: '#15803d' },
  { name: 'Lupo Mannaro', hp_max: 58, ac: 11, initiative_bonus: 1, color: '#3f3f46' },
  { name: 'Cavaliere', hp_max: 52, ac: 18, initiative_bonus: 0, color: '#1d4ed8' },
  { name: 'Sacerdote', hp_max: 27, ac: 13, initiative_bonus: 0, color: '#fef3c7' },
  // CR 5–10
  { name: 'Troll', hp_max: 84, ac: 15, initiative_bonus: 1, color: '#166534' },
  { name: 'Ogre', hp_max: 59, ac: 11, initiative_bonus: -1, color: '#713f12' },
  { name: 'Medusa', hp_max: 127, ac: 15, initiative_bonus: 2, color: '#16a34a' },
  { name: 'Salamandra', hp_max: 90, ac: 15, initiative_bonus: 2, color: '#dc2626' },
  { name: 'Elementale Aria', hp_max: 90, ac: 15, initiative_bonus: 5, color: '#bfdbfe' },
  { name: 'Elementale Acqua', hp_max: 114, ac: 14, initiative_bonus: 2, color: '#0ea5e9' },
  { name: 'Elementale Fuoco', hp_max: 102, ac: 13, initiative_bonus: 3, color: '#ea580c' },
  { name: 'Elementale Terra', hp_max: 126, ac: 17, initiative_bonus: -1, color: '#78716c' },
  { name: 'Yuan-ti', hp_max: 88, ac: 14, initiative_bonus: 2, color: '#15803d' },
  { name: 'Aboleth', hp_max: 135, ac: 17, initiative_bonus: -1, color: '#0c4a6e' },
  { name: 'Erinni', hp_max: 153, ac: 18, initiative_bonus: 3, color: '#dc2626' },
  // CR 10+ "boss"
  { name: 'Drago Giov. Bianco', hp_max: 133, ac: 17, initiative_bonus: 0, color: '#dbeafe' },
  { name: 'Drago Giov. Verde', hp_max: 136, ac: 18, initiative_bonus: 1, color: '#16a34a' },
  { name: 'Drago Giov. Rosso', hp_max: 178, ac: 18, initiative_bonus: 0, color: '#dc2626' },
  { name: 'Drago Giov. Blu', hp_max: 152, ac: 18, initiative_bonus: 0, color: '#3b82f6' },
  { name: 'Drago Giov. Nero', hp_max: 127, ac: 18, initiative_bonus: 2, color: '#1f2937' },
  { name: 'Idra', hp_max: 172, ac: 15, initiative_bonus: 1, color: '#16a34a' },
  { name: 'Behir', hp_max: 168, ac: 17, initiative_bonus: 3, color: '#1d4ed8' },
  { name: 'Roc', hp_max: 248, ac: 15, initiative_bonus: 0, color: '#a16207' },
  { name: 'Vampiro', hp_max: 144, ac: 16, initiative_bonus: 4, color: '#7f1d1d' },
  { name: 'Gigante delle Colline', hp_max: 105, ac: 13, initiative_bonus: -1, color: '#854d0e' },
  { name: 'Gigante del Fuoco', hp_max: 162, ac: 18, initiative_bonus: -1, color: '#dc2626' },
  { name: 'Gigante del Gelo', hp_max: 138, ac: 15, initiative_bonus: -1, color: '#dbeafe' },
  { name: 'Gigante della Tempesta', hp_max: 230, ac: 16, initiative_bonus: 2, color: '#7c3aed' },
  { name: 'Drago Antico Rosso', hp_max: 546, ac: 22, initiative_bonus: 0, color: '#991b1b' },
  { name: 'Lich', hp_max: 135, ac: 17, initiative_bonus: 3, color: '#581c87' },
  { name: 'Pit Fiend', hp_max: 300, ac: 19, initiative_bonus: 2, color: '#7f1d1d' },
  { name: 'Balor', hp_max: 262, ac: 19, initiative_bonus: 2, color: '#dc2626' },
  { name: 'Tarrasque', hp_max: 676, ac: 25, initiative_bonus: 0, color: '#7c2d12' },
]
